            ...
            <nav class="navbar navbar-expand-lg bg-light fixed-top">
                <div class="container-fluid">
                    ...
                    <span class="navbar-text">
                        <?php
                            if (isset($_GET['login'])) {
                                $login=$_GET['login']; // Récupération du login stocké dans l'url
                                echo "Bienvenue <strong>".$login."</strong> !"; // Affichage d'un message personnalisé.
                            }
                        ?>
                    </span>
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav ms-auto"> 
                            <button type="button" class="btn btn-link nav-link" onclick="document.location.href='main.php';">Déconnexion</button>
